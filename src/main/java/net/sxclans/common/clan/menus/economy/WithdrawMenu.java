...
public class WithdrawMenu {
    ...
    public WithdrawMenu(FilesManagerInterface filesManager) {
        FileConfiguration fileConfig = filesManager.getMenuConfig("withdraw");
        this.economy = new VaultEconomyProvider();
        this.config = new WithdrawConfig(
    ...
    public void openWithdrawGUI(Player player, Clan clan) {
        ...
        new AnvilGUI.Builder()
                ...
                .onClick((slot, stateSnapshot) -> {
                    ...
                    return Stream.of(
                                    ...
                                    Map.entry(amountOpt.map(amount -> clan.getBank() < amount).orElse(false), config.errorInsufficientFunds())
                            )
                            ...
                            .orElseGet(() -> {
                                ...
                                clan.withdrawMoneyFromBank(amount);
                                clan.save();
    ...
    private record WithdrawConfig(
        ...
        public WithdrawConfig {
            if (title == null || inputText == null || icon == null || successMessage == null) {
                throw new IllegalArgumentException("Required configuration values are missing in withdraw.yml");
            }
        }
    }
}
